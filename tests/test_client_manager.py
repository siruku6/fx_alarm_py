...
examples_for_detector = (
    ...
    (
        ...
        datetime.datetime(2020, 7, 8, 11),
        datetime.datetime(2020, 7, 8),
        datetime.datetime(2020, 7, 8, 11),
    ),
    # Case2: No missing candles
    (
        datetime.datetime(2020, 7, 8, 1),
        datetime.datetime(2020, 7, 8, 10),
        datetime.datetime(2020, 7, 8, 11),
        datetime.datetime(2020, 7, 8),
    ),
...
def test___detect_missings(
    start, end, exp_missing_start, exp_missing_end, client, past_usd_candles
):
...
def test_prepare_one_page_transactions(client, dummy_raw_open_trades, past_transactions):
    ...
    with patch("oandapyV20.API.request", return_value=dummy_raw_open_trades):
        ...
        with patch(
            "src.clients.oanda_client.OandaClient.request_transactions_once",
