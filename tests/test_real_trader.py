...
def test_not_entry(real_trader_client, dummy_candles, dummy_indicators):
    ...
    with patch('src.real_trader.RealTrader._RealTrader__since_last_loss', return_value=no_time_since_lastloss):
    ...
    with patch('src.real_trader.RealTrader._RealTrader__since_last_loss', return_value=two_hours_since_lastloss):
        result = real_trader_client._RealTrader__drive_entry_process(
